...
def test_scheduler_with_date():
    ...
    context = {
        "user_input": "Thursday from 18:00 to 20:00 studying math division"
    }
...
def test_scheduler_fills_entire_window():
    ...
    context = {
        "user_input": "Tomorrow from 14:00 to 16:00 studying Python and Data Structures"
    }
...
def test_varied_tasks():
    ...
    context = {
        "user_input": "Today from 09:00 to 12:00 studying Calculus"
    }
